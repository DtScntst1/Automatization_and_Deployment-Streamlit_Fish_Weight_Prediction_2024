...
st.image("Fish.jpg", caption="Fish", width=600)
# load model
...
if st.button('Make Prediction'):
    ...
    st.write(f"Thank you {name}! I hope you liked it.")
    st.write("If you want to see more advanced applications you can follow me on [medium](https://medium.com/@gkeretchashvili)")
